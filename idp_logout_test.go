...
func TestValidateEncodedLogoutRequestPOST(t *testing.T) {
	...
	req, sp, err := idp.ValidateEncodedLogoutRequestPOST(context.Background(), encoded)
	...
	require.Equal(t, "https://sp.test/metadata", sp.EntityID)
}
...
func TestValidateEncodedLogoutRequestRedirect(t *testing.T) {
	...
	req, sp, err := idp.ValidateEncodedLogoutRequestRedirect(context.Background(), encoded, "relay123", "", "")
	require.NoError(t, err)
...
func TestBuildLogoutResponseDocument(t *testing.T) {
	...
	doc, err := idp.BuildLogoutResponseDocument("https://sp.test/metadata", StatusCodeSuccess, "_logout123", "https://sp.test/slo")
	require.NoError(t, err)
...
func TestBuildLogoutResponseDocument_UnknownSP(t *testing.T) {
	...
	_, err := idp.BuildLogoutResponseDocument("https://unknown.test", StatusCodeSuccess, "_logout123", "https://sp.test/slo")
	require.Error(t, err)
	require.ErrorIs(t, err, ErrUnknownSP)
}
...
func TestBuildLogoutResponseBodyPost(t *testing.T) {
	...
	body, err := idp.BuildLogoutResponseBodyPost("https://sp.test/metadata", StatusCodeSuccess, "_logout123", "https://sp.test/slo", "relay456")
	require.NoError(t, err)
...
func TestBuildLogoutRequestDocument(t *testing.T) {
	...
	doc, err := idp.BuildLogoutRequestDocument("https://sp.test/metadata", "user@example.com", NameIdFormatEmailAddress, "_session123")
	require.NoError(t, err)
	require.NotNil(t, doc)
	...
	require.Contains(t, xmlStr, NameIdFormatEmailAddress)
...
func TestBuildLogoutRequestDocument_UnknownSP(t *testing.T) {
	...
	_, err := idp.BuildLogoutRequestDocument("https://unknown.test", "user@example.com", NameIdFormatEmailAddress, "_session123")
	require.Error(t, err)
	require.ErrorIs(t, err, ErrUnknownSP)
}
...
func TestBuildLogoutRequestDocument_NoSLOURL(t *testing.T) {
	...
	doc, err := idp.BuildLogoutRequestDocument("https://sp.test/metadata", "user@example.com", NameIdFormatEmailAddress, "")
	require.NoError(t, err)
	require.NotNil(t, doc)

...
var oneLoginScenarioErrors = map[int]string{
	...
	98:  "error validating response: saml: encrypted assertion requires a signed response",
	1:   "",
	3:   "",
	4:   "",
	5:   "error validating response: saml: encrypted assertion requires a signed response",
	6:   "error validating response: saml: encrypted assertion requires a signed response",
	7:   "",
	8:   "",
	9:   "",
	...
	16:  "error validating response: saml: encrypted assertion requires a signed response",
	...
	83:  "",
	84:  "",
	23:  "error validating response: saml: encrypted assertion requires a signed response",
	24:  "error validating response: saml: encrypted assertion requires a signed response",
	26:  "error validating response: saml: assertion expired: NotOnOrAfter 2017-08-30T23:19:41.379Z, now 2017-08-30T23:55:00Z",
	28:  "error validating response: saml: encrypted assertion requires a signed response",
	...
	36:  "error validating response: saml: encrypted assertion requires a signed response",
	...
	97:  "error validating response: saml: encrypted assertion requires a signed response",
	46:  "error validating response: saml: encrypted assertion requires a signed response",
	...
	25:  "error validating response: saml: assertion not yet valid: NotBefore 2017-08-30T23:09:41.379Z, now 2017-08-30T23:00:00Z",
	27:  "error validating response: saml: encrypted assertion requires a signed response",
	50:  "",
	...
	53:  "error validating response: saml: audience mismatch",
	...
	58:  "error validating response: saml: audience mismatch",
	...
	158: "error validating response: saml: audience mismatch",

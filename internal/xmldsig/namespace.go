...
func NSDetach(ctx NSContext, el *xmltree.Element) (*xmltree.Element, error) {
	ctx, err := ctx.SubContext(el)
	if err != nil {
		return nil, err
	}
...
// that child.
func NSIterateChildren(ctx NSContext, el *xmltree.Element, handle NSIterHandler) error {
	ctx, err := ctx.SubContext(el)
	if err != nil {
		return err
	}
...
func NSFindChildrenIterateCtx(ctx NSContext, el *xmltree.Element, namespace, tag string, handle NSIterHandler) error {
	err := NSIterateChildren(ctx, el, func(ctx NSContext, el *xmltree.Element) error {
		_ctx, err := ctx.SubContext(el)
		if err != nil {
			return err
		}
...
func NSFindOneChild(el *xmltree.Element, namespace, tag string) (*xmltree.Element, error) {
...
func NSFindOneChildCtx(ctx NSContext, el *xmltree.Element, namespace, tag string) (*xmltree.Element, error) {
	var found *xmltree.Element

	err := NSFindChildrenIterateCtx(ctx, el, namespace, tag, func(ctx NSContext, el *xmltree.Element) error {
		found = el
		return ErrTraversalHalted
	})

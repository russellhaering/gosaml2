...
This document tracks 334 security test cases for the gosaml2 library, organized across 7 categories. It was audited against the `v2` test suite after the original tracking effort. Each test case is classified by its current coverage:
...
## Category 7: Algorithmic Complexity & Replay Hardening (24 tests)
...
| 7. Algorithmic Complexity & Replay Hardening | 24 | 0 | 24 | 0 | 0 | 0 |
| **Total** | **334** | **104** | **191** | **23** | **16** | **0** |

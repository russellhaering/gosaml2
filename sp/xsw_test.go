...
func xswKeyStore(t *testing.T) *saml2.KeyStore {
	t.Helper()
...
func xswSigner(t *testing.T, ks *saml2.KeyStore) *dsig.Signer {
	t.Helper()
...
func xswServiceProvider(t *testing.T, ks *saml2.KeyStore) *ServiceProvider {
	t.Helper()

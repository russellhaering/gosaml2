...
func signRedirectParams(
	...
	sigAlg := signatureMethodIdentifier(key, hash)
...
func TestVuln_UnknownSigAlg_FallsBackToSHA256(t *testing.T) {
	...
	xmlMsg := makeLogoutResponseXML("https://idp.example.com", "https://sp.example.com/slo", StatusCodeSuccess)
...
func TestVuln_RedirectLogoutResponse_EmptyDestination(t *testing.T) {
	...
	xmlMsg := makeLogoutResponseXML("https://idp.example.com", "", StatusCodeSuccess)
	encoded := deflateAndEncode(t, xmlMsg)
	sigAlg, sig := signRedirectParams(t, key, crypto.SHA256, "SAMLResponse", encoded, "")
...
func TestVuln_RedirectLogoutResponse_WrongDestination(t *testing.T) {
	...
	xmlMsg := makeLogoutResponseXML("https://idp.example.com", "https://evil.example.com/slo", StatusCodeSuccess)
	encoded := deflateAndEncode(t, xmlMsg)
	sigAlg, sig := signRedirectParams(t, key, crypto.SHA256, "SAMLResponse", encoded, "")
...
func TestSignatureAlgorithmHash_Mapping(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			got := signatureAlgorithmHash(tc.algorithm)
...
func TestRedirect_DecompressionBomb(t *testing.T) {
	...
	largeXML := makeLogoutResponseXML("https://idp.example.com", "https://sp.example.com/slo", StatusCodeSuccess)
